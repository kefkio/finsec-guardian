...
const AuditLog = () => {
  ...
  const filtered = auditEntries.filter(e => e.action.toLowerCase().includes(searchTerm.toLowerCase()) || e.actor.toLowerCase().includes(searchTerm.toLowerCase()) || e.details.toLowerCase().includes(searchTerm.toLowerCase()));
  return /*#__PURE__*/_jsxs("div", {
    className: "space-y-6",
    children: [/*#__PURE__*/_jsxs("div", {
      children: [/*#__PURE__*/_jsxs("h1", {
        className: "text-2xl font-bold tracking-tight",
        children: ["Audit ", /*#__PURE__*/_jsx("span", {
          className: "text-gradient-primary",
          children: "Log"
        })]
      }), /*#__PURE__*/_jsx("p", {
        className: "text-sm text-muted-foreground font-mono mt-1",
        children: "Tamper-evident security event log with forensic detail"
      })]
    }), /*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx("div", {
        ...
        className: "space-y-4",
        children: filtered.map(entry => /*#__PURE__*/_jsxs("div", {
          className: "relative pl-14",
          children: [/*#__PURE__*/_jsx("div", {
            className: `absolute left-[18px] top-4 h-3 w-3 rounded-full border-2 border-background ${entry.severity === "critical" ? "bg-destructive" : entry.severity === "warning" ? "bg-warning" : "bg-info"}`
          }), /*#__PURE__*/_jsx(Card, {
            ...
            children: /*#__PURE__*/_jsxs(CardContent, {
              ...
              children: [/*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsxs("div", {
                  ...
                  children: [/*#__PURE__*/_jsxs("div", {
                    ...
                    children: [/*#__PURE__*/_jsx(Badge, {
                      variant: "outline",
                      className: `font-mono text-[10px] ${severityStyles[entry.severity]}`,
                      children: entry.severity.toUpperCase()
                    }), /*#__PURE__*/_jsx("span", {
                ...
                className: "flex gap-4 mt-2 text-[11px] font-mono text-muted-foreground",
