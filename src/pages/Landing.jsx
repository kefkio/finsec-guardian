    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-900 to-gray-900 text-white">
      <header className="mb-12 text-center">
        ...
        <p className="text-xl max-w-xl mx-auto opacity-80">
          Secure your smart contracts with advanced automated auditing and threat detection. Inspired by SolidityScan.
        </p>
      </header>
      <div className="flex gap-8 mb-12">
        ...
        <button
          className="px-8 py-3 rounded bg-gray-800 hover:bg-gray-700 font-semibold text-lg shadow-lg transition"
